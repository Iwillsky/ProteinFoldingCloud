...
do
    echo $e
    $HHBLITS -i $prev_a3m -oa3m $tmp_dir/${curJobId}.$e.a3m -e $e -v 0
    hhfilter -id 90 -cov 75 -i $tmp_dir/${curJobId}.$e.a3m -o $tmp_dir/${curJobId}.$e.id90cov75.a3m
    hhfilter -id 90 -cov 50 -i $tmp_dir/${curJobId}.$e.a3m -o $tmp_dir/${curJobId}.$e.id90cov50.a3m
    prev_a3m="$tmp_dir/${curJobId}.$e.id90cov50.a3m"
    n75=`grep -c "^>" $tmp_dir/${curJobId}.$e.id90cov75.a3m`
    n50=`grep -c "^>" $tmp_dir/${curJobId}.$e.id90cov50.a3m`
